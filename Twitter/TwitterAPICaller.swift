...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "vbmHIWM9ciHOmIizcQiEtgPts", consumerSecret: "hV0rpGAOa5CCEPy6XOvh5ObM4CS49sBzzkvL93NSh7ijKcvT9V")
    var loginSuccess: (() -> ())?
